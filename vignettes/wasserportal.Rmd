...
try({
  ...
  write_csv(swl_master, file = "swl_master.csv")
  ...
  write_csv(swl_data, file = "swl_data.csv")
  ...
  write_csv(swl_data_stats_export, file = "swl_data_stats.csv")
})
```
...
try({
  ...
  write_csv(gwl_master, file = "gwl_master.csv")
  ...
  write_csv(gwl_data, file = "gwl_data.csv")
  ...
  write_csv(gwl_data_stats_export, file = "gwl_data_stats.csv")
...
try({
  ...
  write_csv(gwq_master, file = "gwq_master.csv")
  ...
  write_csv(gw_master, file = "gw_master.csv")
