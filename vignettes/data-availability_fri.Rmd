...
readr::write_csv2(foerdermengen_fri_gal, 
                 file = file.path(paths$figures_dir,
                                  "foerdermengen_fri_gal.csv")
                 )
...
readr::write_csv2(labordaten_ww_timeseries,
                 file = file.path(paths$figures_dir,
                                  "Zeitreihen_FRI_Guete_Rohwasser.csv")
                 )
...
readr::write_csv2(labordaten_ww_stats,
                 file = file.path(paths$figures_dir,
                                  "Stats_FRI_Guete_Rohwasser.csv"))
