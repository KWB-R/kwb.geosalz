...
system.time(csv_paths <- kwb.geosalz::download_measurementchains_data(
  sftp_paths = mc_files$sftp_path[1:10],
  target_directory)
)

system.time(mc_data <- kwb.geosalz::read_measurementchains_data(csv_paths))
